...
public class ViewEmpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("VIEW EMPLOYEES PANEL");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Make A Choice");

        jrSingleEmp.setBackground(new java.awt.Color(1, 101, 99));
        buttonGroup1.add(jrSingleEmp);
        jrSingleEmp.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jrSingleEmp.setForeground(new java.awt.Color(255, 255, 255));
        jrSingleEmp.setText("View Single Employee");

        jrAllEmp.setBackground(new java.awt.Color(1, 101, 99));
        buttonGroup1.add(jrAllEmp);
        jrAllEmp.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    ...
    private void btnDoTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoTaskActionPerformed
        if(jrSingleEmp.isSelected()){
            ViewSingleEmpFrame vsf=new ViewSingleEmpFrame();
            vsf.setVisible(true);
            this.dispose();
        }
        else if(jrAllEmp.isSelected()){
            ViewAllEmpFrame vsf=new ViewAllEmpFrame();
            vsf.setVisible(true);
            this.dispose();
        }
        else{
